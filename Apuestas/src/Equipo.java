...
public class Equipo implements Serializable {
	...
	public Equipo(String nom, int golesF, int golesC, int partidosG,
			int partidosP) {

		// Introducimos los datos en los atributos con los respectivos
		// parámetros utilizando los métodos SET
		setNombre(nom);
	...
	//Método para devolver el nombre del Equipo al JComboBox.
